...
//************************************* Admin Validation ********************************
    ...
    $this->db->join('user','user_role.role_id = user.user_role_id');
    $this->db->join('access_rights','access_rights.role_id = user_role.role_id');
    $this->db->join('module','module.module_id = access_rights.module_id');
		$this->db->where('user.user_username',$name);
		$query=$this->db->get();
